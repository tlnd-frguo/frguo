...
package testproject801.sleep3600_0_1;
...
/**
 * Job: sleep3600 Purpose: <br>
 * Description:  <br>
 * @author security, security
 * @version 8.0.1.20211020_1937-SNAPSHOT
 * @status 
 */
public class sleep3600 implements TalendJob {
	static {System.setProperty("TalendJob.log", "sleep3600.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(sleep3600.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "sleep3600";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_OV7QgD74Ee2No9Rtdiq77w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sleep3600.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = sleep3600.class.getClassLoader()
					.getResourceAsStream("testproject801/sleep3600_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = sleep3600.class.getClassLoader()
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSleep_1{
                    ...
                    log4jParamters_tSleep_1.append("Parameters:");
                            log4jParamters_tSleep_1.append("PAUSE" + " = " + "3600");
 ...
 */
    ...
    public static void main(String[] args){
        final sleep3600 sleep3600Class = new sleep3600();

        int exitCode = sleep3600Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'sleep3600' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'sleep3600' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = sleep3600.class.getClassLoader().getResourceAsStream("testproject801/sleep3600_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sleep3600.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tSleep_1Process(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sleep3600");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     39718 characters generated by Talend Data Fabric 
 *     on the September 28, 2022 at 2:45:09 PM CST
 ************************************************************************************************/