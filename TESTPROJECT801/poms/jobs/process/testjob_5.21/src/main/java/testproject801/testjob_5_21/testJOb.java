...
package testproject801.testjob_5_21;
...
public String getAa(){
	...
	private final String jobVersion = "5.21";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JW6RkCd6Ee2e0N67cQIp7Q", "5.21");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_5_21/contexts/" + context + ".properties");
			if (inContext == null) {
...
System.out.println("JOB VERSION: 5.2.1");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = testJOb.class.getClassLoader().getResourceAsStream("testproject801/testjob_5_21/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the September 13, 2022 at 5:10:00 PM CST
 ************************************************************************************************/