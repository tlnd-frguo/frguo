...
package testproject801.job21_1_2;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_szIskCjNEe2mT6D11qBFjQ", "1.2");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = job21.class.getClassLoader()
					.getResourceAsStream("testproject801/job21_1_2/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job21.class.getClassLoader().getResourceAsStream("testproject801/job21_1_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     38768 characters generated by Talend Data Fabric 
 *     on the August 31, 2022 at 10:20:43 AM CST
 ************************************************************************************************/