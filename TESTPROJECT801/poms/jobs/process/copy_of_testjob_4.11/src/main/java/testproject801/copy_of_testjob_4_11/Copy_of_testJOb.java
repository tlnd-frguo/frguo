...
package testproject801.copy_of_testjob_4_11;
...
/**
 * Job: Copy_of_testJOb Purpose: <br>
 * Description:  <br>
 * @author security, security
 * @version 8.0.1.20211020_1937-SNAPSHOT
 * @status 
 */
public class Copy_of_testJOb implements TalendJob {
	static {System.setProperty("TalendJob.log", "Copy_of_testJOb.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Copy_of_testJOb.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobVersion = "4.11";
	private final String jobName = "Copy_of_testJOb";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JMXL8CjOEe2mT6D11qBFjQ", "4.11");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Copy_of_testJOb.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Copy_of_testJOb.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/copy_of_testjob_4_11/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_testJOb.class.getClassLoader()
 ...
 */
    ...
    public static void main(String[] args){
        final Copy_of_testJOb Copy_of_testJObClass = new Copy_of_testJOb();

        int exitCode = Copy_of_testJObClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Copy_of_testJOb' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Copy_of_testJOb' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Copy_of_testJOb.class.getClassLoader().getResourceAsStream("testproject801/copy_of_testjob_4_11/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Copy_of_testJOb.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Copy_of_testJOb");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     38983 characters generated by Talend Data Fabric 
 *     on the August 31, 2022 at 9:42:32 AM CST
 ************************************************************************************************/