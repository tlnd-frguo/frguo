...
package testproject801.testjob_7_20;
...
public String getAa(){
	...
	private final String jobVersion = "7.20";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JW6RkCd6Ee2e0N67cQIp7Q", "7.20");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_7_20/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = testJOb.class.getClassLoader().getResourceAsStream("testproject801/testjob_7_20/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the September 19, 2022 at 2:53:18 PM CST
 ************************************************************************************************/