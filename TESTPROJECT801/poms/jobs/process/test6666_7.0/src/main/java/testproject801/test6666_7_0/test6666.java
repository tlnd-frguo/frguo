...
package testproject801.test6666_7_0;
...
public String getAa(){
	...
	private final String jobVersion = "7.0";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_GkCSYCnMEe2P04LUTQCSrw", "7.0");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = test6666.class.getClassLoader()
					.getResourceAsStream("testproject801/test6666_7_0/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test6666.class.getClassLoader().getResourceAsStream("testproject801/test6666_7_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     41927 characters generated by Talend Data Fabric 
 *     on the September 14, 2022 at 5:18:13 PM CST
 ************************************************************************************************/