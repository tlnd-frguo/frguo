...
package testproject801.job21_0_7;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_szIskCjNEe2mT6D11qBFjQ", "0.7");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = job21.class.getClassLoader()
					.getResourceAsStream("testproject801/job21_0_7/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job21.class.getClassLoader().getResourceAsStream("testproject801/job21_0_7/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the August 31, 2022 at 10:13:06 AM CST
 ************************************************************************************************/