...
package testproject801.testjob_6_1;
...
public String getAa(){
	...
	private final String jobVersion = "6.1";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JW6RkCd6Ee2e0N67cQIp7Q", "6.1");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_6_1/contexts/" + context + ".properties");
			if (inContext == null) {
...
System.out.println("JOB VERSION: 6.1.0");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = testJOb.class.getClassLoader().getResourceAsStream("testproject801/testjob_6_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the September 13, 2022 at 5:11:56 PM CST
 ************************************************************************************************/