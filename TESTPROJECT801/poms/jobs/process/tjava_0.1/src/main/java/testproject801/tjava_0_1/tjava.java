...
package testproject801.tjava_0_1;
 ...
 * @status
 */
public class tjava implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "tjava.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(tjava.class);
	...
	private final String jobName = "tjava";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tjava.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = tjava.class.getClassLoader()
					.getResourceAsStream("testproject801/tjava_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = tjava.class.getClassLoader()
	...
	public static void main(String[] args) {
		final tjava tjavaClass = new tjava();

		int exitCode = tjavaClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'tjava' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'tjava' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = tjava.class.getClassLoader()
					.getResourceAsStream("testproject801/tjava_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tjava.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tjava");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 41269 characters generated by Talend Data Fabric on the August 31, 2022 at
 * 4:49:50 PM CST
 ************************************************************************************************/