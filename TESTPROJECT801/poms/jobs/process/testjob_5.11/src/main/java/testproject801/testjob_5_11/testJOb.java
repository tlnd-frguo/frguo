...
package testproject801.testjob_5_11;
...
public class testJOb implements TalendJob {
	...
	private final String jobVersion = "5.11";
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_5_11/contexts/" + context + ".properties");
			if (inContext == null) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_5_11/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testJOb.class.getClassLoader()
...
/************************************************************************************************
 * 41316 characters generated by Talend Data Fabric on the August 31, 2022 at
 * 4:53:02 PM CST
 ************************************************************************************************/