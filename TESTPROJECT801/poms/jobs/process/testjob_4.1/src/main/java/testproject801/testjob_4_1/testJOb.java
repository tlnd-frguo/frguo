...
package testproject801.testjob_4_1;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JW6RkCd6Ee2e0N67cQIp7Q", "4.1");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_4_1/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = testJOb.class.getClassLoader().getResourceAsStream("testproject801/testjob_4_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the August 30, 2022 at 1:51:48 PM CST
 ************************************************************************************************/