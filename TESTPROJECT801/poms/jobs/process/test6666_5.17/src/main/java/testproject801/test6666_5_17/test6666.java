...
package testproject801.test6666_5_17;
...
/**
 * Job: test6666 Purpose: <br>
 * Description:  <br>
 * @author security, security
 * @version 8.0.1.20211020_1937-SNAPSHOT
 * @status 
 */
public class test6666 implements TalendJob {
	static {System.setProperty("TalendJob.log", "test6666.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(test6666.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(aa != null){
					...
					this.setProperty("aa", aa.toString());
...
public String getAa(){
	...
	private final String jobVersion = "5.17";
	private final String jobName = "test6666";
	private final String projectName = "TESTPROJECT801";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_GkCSYCnMEe2P04LUTQCSrw", "5.17");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(test6666.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = test6666.class.getClassLoader()
					.getResourceAsStream("testproject801/test6666_5_17/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = test6666.class.getClassLoader()
...
System.out.println("JOB VERSION: 0.1.0");
 ...
 */
    ...
    public String contextStr = "custom";
    ...
    public static void main(String[] args){
        final test6666 test6666Class = new test6666();

        int exitCode = test6666Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'test6666' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'test6666' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = test6666.class.getClassLoader().getResourceAsStream("testproject801/test6666_5_17/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = test6666.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        if(context.getStringValue("name") == null) {
                            context.name = null;
                        } else {
                        ...
                        context.setContextType("aa", "id_String");
                        if(context.getStringValue("aa") == null) {
                            context.aa = null;
                        } else {
                            context.aa=(String) context.getProperty("aa");
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("name")) {
            ...
            }if (parentContextMap.containsKey("aa")) {
                context.aa = (String) parentContextMap.get("aa");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test6666");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     41932 characters generated by Talend Data Fabric 
 *     on the September 1, 2022 at 4:02:43 PM CST
 ************************************************************************************************/