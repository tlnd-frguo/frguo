...
package testproject801.test6666_7_4;
...
public String getAa(){
	...
	private final String jobVersion = "7.4";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_GkCSYCnMEe2P04LUTQCSrw", "7.4");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = test6666.class.getClassLoader()
					.getResourceAsStream("testproject801/test6666_7_4/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test6666.class.getClassLoader().getResourceAsStream("testproject801/test6666_7_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the September 14, 2022 at 5:48:55 PM CST
 ************************************************************************************************/