...
package testproject801.testjob_5_2;
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobVersion = "5.2";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JW6RkCd6Ee2e0N67cQIp7Q", "5.2");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = testJOb.class.getClassLoader()
					.getResourceAsStream("testproject801/testjob_5_2/contexts/" + context + ".properties");
			if (inContext == null) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = testJOb.class.getClassLoader().getResourceAsStream("testproject801/testjob_5_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the August 31, 2022 at 1:30:43 PM CST
 ************************************************************************************************/