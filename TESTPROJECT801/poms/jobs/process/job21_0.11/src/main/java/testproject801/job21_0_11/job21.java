...
package testproject801.job21_0_11;
...
/**
 * Job: job21 Purpose: <br>
 * Description:  <br>
 * @author security, security
 * @version 8.0.1.20211020_1937-SNAPSHOT
 * @status 
 */
public class job21 implements TalendJob {
	static {System.setProperty("TalendJob.log", "job21.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(job21.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job21";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_szIskCjNEe2mT6D11qBFjQ", "0.11");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job21.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = job21.class.getClassLoader()
					.getResourceAsStream("testproject801/job21_0_11/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = job21.class.getClassLoader()
 ...
 */
    ...
    public static void main(String[] args){
        final job21 job21Class = new job21();

        int exitCode = job21Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job21' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'job21' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = job21.class.getClassLoader().getResourceAsStream("testproject801/job21_0_11/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job21.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job21");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     38773 characters generated by Talend Data Fabric 
 *     on the August 31, 2022 at 10:17:05 AM CST
 ************************************************************************************************/